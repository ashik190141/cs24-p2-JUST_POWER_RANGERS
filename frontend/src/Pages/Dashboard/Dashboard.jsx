                ...
                <ul className="menu flex flex-col mt-8 px-6 space-y-3">
                  ...
                  <li>
                    <NavLink
                      ...
                      to="create-sts"
                    >
                      <FaPlaceOfWorship></FaPlaceOfWorship>Add New STS
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      ...
                      to="create-landfill"
                    >
                      <FaPlaceOfWorship></FaPlaceOfWorship>Add New Landfill
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
              ...
              <>
                <ul className="flex flex-col mt-10 px-6 space-y-3">
                  <li>
                    ...
                    >
                      <FaDatabase></FaDatabase>Data Entry
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
